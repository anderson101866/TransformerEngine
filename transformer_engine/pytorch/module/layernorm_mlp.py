    ...
    def forward(
        ...
        if ub_overlap_ag:
            ...
            if ub_obj_lnout.is_atomic_gemm():
                ...
                ub_algo_ag = tex.NVTE_Comm_Overlap_Algo.SPLIT_PIPELINED_AG_P2P
            ...
            if ub_overlap_rs:
                ...
                if ub_obj_fc2out.is_p2p_overlap():
                    if ub_obj_fc2out.is_atomic_gemm():
                        ub_algo_rs = tex.NVTE_Comm_Overlap_Algo.ATOMIC_GEMM_RS_P2P
                    else:
                        ub_algo_rs = tex.NVTE_Comm_Overlap_Algo.SPLIT_PIPELINED_RS_P2P
                else:
                    if ub_obj_fc2out.is_atomic_gemm():
                        ub_algo_rs = tex.NVTE_Comm_Overlap_Algo.ATOMIC_GEMM_RS
                    else:
                        ub_algo_rs = tex.NVTE_Comm_Overlap_Algo.SPLIT_PIPELINED_RS
                ...
                if ctx.fp8:
                    ...
                    if not ctx.fp8_meta["recipe"].override_linear_precision.wgrad:
                        ...
                        fc1_wgrad, _ = tex.fp8_gemm(
                            ...
                            use_split_accumulator=_2X_ACC_WGRAD,
                            ub_algo=(
                                tex.NVTE_Comm_Overlap_Algo.BULK_OVERLAP_RS
                                if ctx.ub_bulk_wgrad
                                else None
                            ),
