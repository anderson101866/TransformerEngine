...
from transformer_engine.paddle.layer.ubgemm import get_ub, UbGemmType #excplit use a low-level API because this example mimic the fprop parts of te.Linear
...
def train(args, tp_group):
    ...
    if args.comm_type == tex.NVTE_Comm_Overlap_Type.AG:
        ub_obj = get_ub(te.UbGEMM.fc1, UbGemmType.fprop)
        ...
        ub_obj = get_ub(te.UbGEMM.fc2, UbGemmType.fprop)
